...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20251001.IVirtualNetworkPeering
.Link
...
function Update-AzDatabricksVNetPeering {
    [OutputType([Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20251001.IVirtualNetworkPeering])]
    [Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.OutputBreakingChangeAttribute("Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20251001.IVirtualNetworkPeering", "15.0.0", "2.0.0", "2025/11/03", ReplacementCmdletOutputType = "Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.IVirtualNetworkPeering", DeprecatedOutputProperties = ("DatabrickAddressSpaceAddressPrefix, RemoteAddressSpaceAddressPrefix 'System.String[]'"), NewOutputProperties = ("DatabrickAddressSpaceAddressPrefix, RemoteAddressSpaceAddressPrefix 'System.Collections.Generic.List`1[System.String]'"))]
